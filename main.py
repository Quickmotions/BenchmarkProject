...
def main():
    ...
    systemTag, system, machine, version, release, node,cpuTag, cpuBrand, physCore, allCore, maxFreq,minFreq ,memoryTag, memTotal, memUsed,storageTag, storageDevice = runGetComp()    #collect all system and component info
